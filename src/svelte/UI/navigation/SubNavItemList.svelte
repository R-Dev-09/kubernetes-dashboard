<script lang=ts>
  ...
  import { SubNavItem } from '@UI/navigation';
...
<ul class='w-full bg-white rounded-b-[1.25rem] px-7 pb-4 shadow-xl absolute top-3/4 left-0 overflow-hidden' transition:slide>
